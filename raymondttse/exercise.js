...
exercise.addProperty = function(someObject){
    ...
    // ----------------------------------------
    someObject.name = 'NANANANANANANANANANA BATMAN';
...
exercise.getSalaryTotal = function(people){
    ...
    //     10000
    // ----------------------------------------
    return people.reduce(function(total, item){
...
exercise.getTotalPayroll = function(payroll){
    ...
    // ----------------------------------------
    return payroll.reduce(function(total, item){
        return total + Number(item[3]);
    }, 0);
};
